...
class ComputeLoss_cfg:
    ...
    def __init__(self, model, autobalance=False):
        ...
        yolo_layers=model.module.yolo_layers if is_parallel(model) else model.yolo_layers # Detect() module
        module_list = model.module.module_list if is_parallel(model) else model.module_list  # Detect() module
        stride=[8,16,32]
        self.balance = {3: [4.0, 1.0, 0.4]}.get(len(yolo_layers), [4.0, 1.0, 0.25, 0.06, .02])  # P3-P7
